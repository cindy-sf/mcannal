...
export const StyledText = styled.p<StyledProps>`
  ...
  margin-top: ${({ marginTop }) => marginTop && theme.space[marginTop]};
  margin-right: ${({ marginRight }) => marginRight && theme.space[marginRight]};
  margin-bottom: ${({ marginBottom }) => marginBottom && theme.space[marginBottom]};
  margin-left: ${({ marginLeft }) => marginLeft && theme.space[marginLeft]};
